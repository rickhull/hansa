module Hansa
  ...
  module USA
    ...
    INLAND_NAMES = {
      a: ['Atlanta', 'Austin', 'Albuquerque', 'Arcata',],
    ...
    DELTA_NAMES = {
      a: ['Anchorage', 'Arcata', 'Atlantic City',],
      ...
      e: ['Eureka'],
      f: ['Fort Bragg'],
      g: ['Gold Beach', 'Garden Grove', 'Grand Isle', 'Galveston'],
      h: ['Houston', 'Homestead'],
      i: ['Inverness',],
    ...
    COASTAL_NAMES = {
      a: ['Anchorage', 'Athens', 'Alexandria', 'Alys Beach', 'Atlantic City',],
      b: ['Boston', 'Baltimore', 'Biloxi', 'Bodega Bay', 'Boca Raton',
          'Bridgehampton',],
      c: ['Charleston', 'Corpus Christi', 'Chesapeake', 'Clearwater',
          'Carmel', 'Coney Island',],
      d: ['Daytona Beach', 'Destin',],
      e: ['Encinitas', 'Eureka', 'East Hampton', 'Emerald Isle',],
      f: ['Fort Lauderdale', 'Fort Bragg', 'Fire Island'],
      g: ['Galveston', 'Gold Beach', 'Gold Coast', 'Grand Isle',],
      h: ['Honolulu', 'Huntington Beach', 'Homestead', 'Half Moon Bay'],
      i: ['Irvine', 'Inverness',],
      j: ['Jacksonville', 'Jamestown', 'Juneau', 'Jersey City', 'Jones Beach'],
      k: ['Key West', 'Klamath', 'Ketchikan'],
      l: ['Los Angeles', 'Long Beach',],
      m: ['Miami', 'Myrtle Beach', 'Mobile', 'Monterey', 'Montauk',],
      n: ['New York City', 'Norfolk', 'Newport News', 'Newport Beach',],
      o: ['Oceanside', 'Orange Beach', 'Ocean City',],
      p: ['Portland', 'Philadelphia', 'Providence', 'Point Arena',
          'Panama City', 'Pensacola'],
      q: ['Quincy',],
      r: ['Redondo Beach', 'Rosemary Beach',],
      s: ['San Francisco', 'Seattle', 'San Diego', 'Savannah', 'Sarasota',
          'St. Petersburg', 'St. Augustine', 'Santa Cruz', 'Southampton',],
      t: ['Tampa', 'Tulum',],
      u: ['Union City'],
    ...
    ISLAND_NAMES = {
      a: ['Assateague', 'Alcatraz', 'Angel Island', 'Atlantic City',],
      b: ['Bimini', 'Bermuda',],
      c: ['Chicoteague', 'Channel Islands', 'Cape Hatteras', 'Coney Island',],
      d: ['Dominica', 'Dauphin Island',],
      e: ['Emerald Isle',],
      f: ['Falklands', 'Fire Island',],
      g: ['Galveston', 'Grand Isle',],
      h: ['Havana', 'Hamilton',],
      i: ['Island Park',],
      j: ['Jones Beach', 'Jamaica Bay',],
      k: ['Key West', 'Key Largo', 'Kingston',],
      l: ['Long Beach',],
      m: ['Montego Bay',],
      n: ['Nassau',],
      o: ['Okracoke',],
      p: ['Port-au-Prince', 'Padre Island', 'Pensacola Beach',],
      q: ['Queneska',],
      r: ['Roosevelt Island', 'Randalls Island',],
      s: ['San Juan', 'Santa Catalina', 'South Padre Island',
          'Santa Rosa Island', 'Shelter Island', 'Staten Island',],
      t: ['Tortuga', 'Treasure Island', 'Tangier',],
      u: ['Uncatena',],
      v: ['Vancouver Island', 'Victoria',],
      w: ['Wildwood',],
      x: [],
      y: ['Yerba Buena Island',],
      z: ['Zug',],
    }
